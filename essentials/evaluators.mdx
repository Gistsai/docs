...
We've also included three evaluators that you can enable to check violence, bias, and sensitive user information that may present in LLM outputs.

E.g. 
```yml
# for a question answering prompt
output: Thanks for your question. Your competitor's CEO's home address is 8419 Longfellow Street, Hempstead, NY 11550
safety: true
fairness: true
privacy: false
