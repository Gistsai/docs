...
While ChatGPT is easy to use, it has several major shortcomings for automation:
- Lack of organization of reusable prompts
- Lack of prompt consistency evaluation
- Not sharable with the team
- Hard to compare prompt performance


## Next steps
Let's take a look at how [Gists](/essentials/gists) solves these problems!